...
$ helm install ./api/helm --name productenendienstencatalogus --kubeconfig="api/helm/kubeconfig.yaml"

Or update if you want to update an existing one
$ helm upgrade productenendienstencatalogus  ./api/helm --kubeconfig="api/helm/kubeconfig.yaml" 

Or del if you want to delete an existing  one
$ helm del productenendienstencatalogus  --purge --kubeconfig="api/helm/kubeconfig.yaml" 
