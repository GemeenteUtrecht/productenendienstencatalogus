...
$ helm install ./api/helm --name pdc --kubeconfig="api/helm/kubeconfig.yaml"

Or update if you want to update an existing one
$ helm upgrade pdc  ./api/helm --kubeconfig="api/helm/kubeconfig.yaml" 

Or del if you want to delete an existing  one
$ helm del pdc  --purge --kubeconfig="api/helm/kubeconfig.yaml" 
